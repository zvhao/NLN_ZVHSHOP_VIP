...
function getSampleComment($star) {
	...
	switch ($star) {
		...
		case '4':
			...
			break;
		case '5':
			$content = 'Cảm ơn bạn đã ủng hộ shop nha, shop rất vui khi nhận được 5* từ bạn. Hi vọng bạn sẽ luôn ủng hộ shop và nếu trong quá trình nhận hàng và sử dụng hãy nhắn tin hoặc gọi vào hotline bên mình nhé.';
			break;
